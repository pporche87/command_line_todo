...
// Similarly to your `get.js` and `writeFile.js` modules, you could combine all the modules within commands/ to a single `commands.js` module (since each of them only have one file in them anyways). This would also help reduce the duplication between the different commands.
